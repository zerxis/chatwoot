<template>
  <div
    class="bg-white border-b border-slate-50 h-14 justify-between items-center flex px-2 py-4 w-full"
  >
    <h1 class="text-2xl font-medium flex items-center space-x-3">
